...
<div id="<?php echo $result_post->ID ?>" class="result-wrapper">
 ...
 <div class="details">
  <div class="text"><?php echo extend_wp_search_seach_limit_text($result_post->post_title . '.<br>' . $result_post->post_content, 20, true); ?></div>
  <div class="more"><span><a href="<?php echo $permalink; ?>"><?php echo __('Read more', 'extend-wp-search'); ?></a></span></div>
 </div>
</div>